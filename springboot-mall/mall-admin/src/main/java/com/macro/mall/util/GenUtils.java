...
import com.macro.mall.bo.ColumnDO;
import com.macro.mall.bo.TableDO;
import com.macro.mall.config.Constant;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("Module", tableDO.getTableName().split("_")[0].substring(0,1).toUpperCase()+tableDO.getTableName().split("_")[0].substring(1).toLowerCase());
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(tableDO.getTableName().split("_")[0],template, tableDO.getClassname(), tableDO.getClassName(), packages.substring(packages.lastIndexOf(".") + 1))));
     ...
     * 获取文件名
     */
    public static String getFileName(String module,String template, String classname, String className, String packageName) {
